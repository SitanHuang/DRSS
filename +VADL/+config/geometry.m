...
sys.configParams.rocketDynamics = DRSS.core.dynamics.RocketAerodynamics( ...
  ...
  'L_nose', 9.75 * uc.in_to_m, ... nose cone length
  ...
  't_fin', 0.125 * uc.in_to_m, ... fin thickness
  ...
  'CP', 66.738 * uc.in_to_m ... hardcoded CP (69.488 = DRSS's own calc)
);