...
wind_speed_mph = [5 10 15 20]; % Wind speeds [mph]
temps_F = 45:5:55; % Temperature range [F]
...
exportgraphics(fig, "competition_lrr_variability_0lbm.png", "Resolution", 600);